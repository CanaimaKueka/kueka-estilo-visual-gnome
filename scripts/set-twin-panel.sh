...
# top_panel
gconftool-2 --set /apps/panel/default_setup/general/toplevel_id_list --type=list --list-type=string [top_panel,bottom_panel]
gconftool-2 --set /apps/panel/default_setup/general/object_id_list --type=list --list-type=string [menu_bar_screen,browser_launcher,email_launcher,twitter_launcher]
gconftool-2 --set /apps/panel/default_setup/general/applet_id_list --type=list --list-type=string [show_desktop,window_list,mixer,clock,notification_area,workspace_switch]

gconftool-2 --set /apps/panel/default_setup/objects/menu_bar_screen/locked --type=bool true
gconftool-2 --set /apps/panel/default_setup/objects/menu_bar_screen/object_type --type=string menu-bar
...
gconftool-2 --set /apps/panel/default_setup/objects/email_launcher/launcher_location --type=string guacharo.desktop
gconftool-2 --set /apps/panel/default_setup/objects/email_launcher/locked --type=bool true
gconftool-2 --set /apps/panel/default_setup/objects/email_launcher/object_type --type=string launcher-object
gconftool-2 --set /apps/panel/default_setup/objects/email_launcher/position --type=int 3
gconftool-2 --set /apps/panel/default_setup/objects/email_launcher/toplevel_id --type=string top_panel
...
gconftool-2 --set /apps/panel/default_setup/objects/twitter_launcher/position --type=int 4
...
gconftool-2 --set /apps/panel/default_setup/applets/clock/prefs/show_date --type=bool true
...
gconftool-2 --set /apps/panel/applets/clock/prefs/show_date --type=bool true
...
gconftool-2 --set /apps/panel/objects/menu_bar_screen0/object_type --type=string menu-bar
...
gconftool-2 --set /apps/panel/objects/email_launcher0/launcher_location --type=string guacharo.desktop
gconftool-2 --set /apps/panel/objects/email_launcher0/locked --type=bool true
gconftool-2 --set /apps/panel/objects/email_launcher0/object_type --type=string launcher-object
gconftool-2 --set /apps/panel/objects/email_launcher0/position --type=int 3
gconftool-2 --set /apps/panel/objects/email_launcher0/toplevel_id --type=string top_panel
...
gconftool-2 --set /apps/panel/objects/twitter_launcher0/position --type=int 4
...
gconftool-2 --set /apps/panel/default_setup/applets/show_desktop/position --type=int 0
gconftool-2 --set /apps/panel/default_setup/applets/show_desktop/object_type --type=string bonobo-applet
gconftool-2 --set /apps/panel/default_setup/applets/show_desktop/toplevel_id --type=string bottom_panel
...
gconftool-2 --set /apps/panel/default_setup/applets/window_list/position --type=int 1
gconftool-2 --set /apps/panel/default_setup/applets/window_list/object_type --type=string bonobo-applet
gconftool-2 --set /apps/panel/default_setup/applets/window_list/toplevel_id --type=string bottom_panel

gconftool-2 --set /apps/panel/default_setup/applets/workspace_switch/bonobo_iid --type=string OAFIID:GNOME_WorkspaceSwitcherApplet
gconftool-2 --set /apps/panel/default_setup/applets/workspace_switch/locked --type=bool true
gconftool-2 --set /apps/panel/default_setup/applets/workspace_switch/position --type=int 2
gconftool-2 --set /apps/panel/default_setup/applets/workspace_switch/panel_right_stick --type=bool true
gconftool-2 --set /apps/panel/default_setup/applets/workspace_switch/object_type --type=string bonobo-applet
gconftool-2 --set /apps/panel/default_setup/applets/workspace_switch/toplevel_id --type=string bottom_panel

gconftool-2 --set /apps/panel/general/toplevel_id_list --type=list --list-type=string [top_panel,bottom_panel]
gconftool-2 --set /apps/panel/general/object_id_list --type=list --list-type=string [menu_bar_screen0,browser_launcher0,email_launcher0,twitter_launcher0]
gconftool-2 --set /apps/panel/general/applet_id_list --type=list --list-type=string [show_desktop0,window_list0,mixer0,clock0,notification_area0,workspace_switch0]
...
gconftool-2 --set /apps/panel/applets/show_desktop0/position --type=int 0
gconftool-2 --set /apps/panel/applets/show_desktop0/object_type --type=string bonobo-applet
gconftool-2 --set /apps/panel/applets/show_desktop0/toplevel_id --type=string bottom_panel
...
gconftool-2 --set /apps/panel/applets/window_list0/position --type=int 1
gconftool-2 --set /apps/panel/applets/window_list0/object_type --type=string bonobo-applet
gconftool-2 --set /apps/panel/applets/window_list0/toplevel_id --type=string bottom_panel

gconftool-2 --set /apps/panel/applets/workspace_switch0/bonobo_iid --type=string OAFIID:GNOME_WorkspaceSwitcherApplet
gconftool-2 --set /apps/panel/applets/workspace_switch0/locked --type=bool true
gconftool-2 --set /apps/panel/applets/workspace_switch0/position --type=int 2
gconftool-2 --set /apps/panel/applets/workspace_switch0/panel_right_stick --type=bool true
gconftool-2 --set /apps/panel/applets/workspace_switch0/object_type --type=string bonobo-applet
gconftool-2 --set /apps/panel/applets/workspace_switch0/toplevel_id --type=string bottom_panel
...
gconftool-2 --set /apps/panel/toplevels/bottom_panel/orientation --type=string bottom
